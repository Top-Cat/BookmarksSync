...
import io.beatmaps.bookmarksync.json
...
inline fun <reified T> axiosGet(url: String, ct: CancelToken? = null) = Axios.get<String>(url, generateConfig<String, String>(ct)).then { json.decodeFromString<T>(it.data) }
